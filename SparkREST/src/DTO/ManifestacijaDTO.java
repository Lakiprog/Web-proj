...
public class ManifestacijaDTO {
	...
	public ManifestacijaDTO(Manifestacija manifestacija) {
		this.id = manifestacija.getId();
		this.naziv = manifestacija.getNaziv();
		this.posterLink = manifestacija.getPosterLink();
		this.setDatumVremePocetka(manifestacija.getDatumVremePocetka());
		this.setDatumVremeKraja(manifestacija.getDatumVremeKraja());
		this.geoSirina = manifestacija.getLokacija().getSirina();
		this.geoDuzina = manifestacija.getLokacija().getDuzina();
		this.adresa = manifestacija.getLokacija().getAdresa().toString();
		this.brMesta = manifestacija.getBrMesta();
		this.cenaRegular = manifestacija.getCenaRegular();
		this.status = manifestacija.getStatus();
		this.tip = manifestacija.getTip();
		this.obrisan = manifestacija.isObrisan();
		this.brojOcena = manifestacija.getBrojOcena();
		this.sumaOcena = manifestacija.getSumaOcena();
	}
